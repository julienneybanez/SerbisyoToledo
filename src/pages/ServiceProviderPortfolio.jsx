      ...
      try {
        ...
        if (response.success && response.data) {
          ...
          const transformedProvider = {
            ...
            pricingUnit: apiProfile.pricingUnit || 'per_day',
            maxAdvanceBookingDays: apiProfile.maxAdvanceBookingDays,
            minAdvanceNoticeMinutes: apiProfile.minAdvanceNoticeMinutes,
            allowSameDayBooking: apiProfile.allowSameDayBooking,
